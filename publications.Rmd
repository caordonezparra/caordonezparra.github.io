...
> Silveira FAO, **Ordóñez-Parra CA** & Dayrell RLC (2024). Ecologia funcional da germinação de sementes. In: Borghetti F, ed. _Germinação: princípios, processos e aplicações_. Rede de Sementes do Cerrado.

> Fidelis, AT, **Ordóñez-Parra CA**, Silveira FAO, Dayrell RLC, & López-Mársico L (2024). Germinação e recrutamento em ecossistemas campestres: campos rupestres, campos de altitude e Pampa. In: Borghetti F, ed. _Germinação: princípios, processos e aplicações_. Rede de Sementes do Cerrado.
